...
###############################################################
	...
	def __init__(self, opts, kcrit=1.0, wp=0, wd=[0,0]):
		...
		self.Ffactor = (1-self.B_TOT)/kcrit+sum(
			(self.Bi[:]*self.DECAYi[:])/(wd[:]+self.DECAYi[:])/kcrit)
		self.Rfactor = [wp/self.VEL1, wp/self.VEL2]
...
###############################################################
	...
	def build(self, opts, data):
		...
		for g in range(1,nGrps+1):
			...
			for y in range(nBins):
				for x in range(nBins):
					...
					if y*delta >= 135:
						self.Pfis.append(data['reflector']['fisXS'][g]*self.Ffactor)
						self.fis.append(data['reflector']['fisXS'][g])
						self.abs.append(data['reflector']['absXS'][g])
						self.Premoval.append(data['reflector']['absXS'][g]
						...
						if x*delta >= 105:
							...
							self.Pfis.append(data['fuel3']['fisXS'][g]*self.Ffactor)
							self.fis.append(data['fuel3']['fisXS'][g])
							self.abs.append(data['fuel3']['absXS'][g])
							self.Premoval.append(data['fuel3']['absXS'][g]
						...
						if x*delta >= 120:
							...
							self.Pfis.append(data['fuel4']['fisXS'][g]*self.Ffactor)
							self.fis.append(data['fuel4']['fisXS'][g])
							self.abs.append(data['fuel4']['absXS'][g])
							self.Premoval.append(data['fuel4']['absXS'][g]
						...
						#################################
							...
							self.Pfis.append(data['fuel2']['fisXS'][g]*self.Ffactor)
							self.fis.append(data['fuel2']['fisXS'][g])
							self.abs.append(data['fuel2']['absXS'][g])
							self.Premoval.append(data['fuel2']['absXS'][g]
							...
							self.fis.append(data['fuel1']['fisXS'][g])
							self.abs.append(data['fuel1']['absXS'][g])
							self.Premoval.append(data['fuel1']['absXS'][g]
							+data['fuel1']['Ex'+str(g)][gIn]
							+BZ2*data['fuel1']['D'][g]
							+self.Rfactor[g-1])
							self.removal.append(data['fuel1']['absXS'][g]
		...
		self.Premoval = np.array(self.removal)  # For sparse implementation
		self.Pfis = np.array(self.fis)          # For sparse implementation
