...
# in a modified alpha-eigenvalue scheme with optional repeated time steps
    ...
    ###########################
        ...
        while time < options.t_end: 
            ...
            for r in range(options.repeat_inner+1):
                ...
                sol.hill_alg(options, Matrix, XS, kcrit)
                Flux = copy.copy(sol.flux)
                ...
                # Note: sol.a replaces all frequencies
                Matrix.update_freq(options, XS, kcrit, sol.a, sol.a, sol.a)
                sol.gauss_seidel(options, Matrix.D, Matrix.Otrans, Matrix.Ftrans, XS)
                AdjFlux = copy.copy(sol.flux)
